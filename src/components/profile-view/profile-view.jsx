...
export class ProfileView extends React.Component {
    ...
    getUser = (token) => {
        ...
        axios
            .get(`https://murmuring-bastion-72555.herokuapp.com/users/${username}`, {
    ...
    // We need to allow user to edit or update profile
    ...
    editUser = (e) => {
        ...
        axios.put(`https://murmuring-bastion-72555.herokuapp.com/users/${username}`,
            {
    ...
    onRemoveFavorite() {
        ...
        axios.delete(`https://murmuring-bastion-72555.herokuapp.com/users/${username}/movies/${movie._id}`, {
            headers: { Authorization: `Bearer ${token}` }
        })
            .then((response) => {
    ...
    onDeleteUser() {
        ...
        axios.delete(`https://murmuring-bastion-72555.herokuapp.com/user/${username}`, {
            headers: { Authorization: `Bearer ${token}` },
        })
            .then((response) => {
                console.log(response);
